...
<li class="breadcrumb-item">
	<a href="{{ url('/admin/clients/1') }}"><i class="fas fa-handshake"></i> Cliente</a>
</li>
<li class="breadcrumb-item">
	<a href="{{ url('/admin/client/add') }}"><i class="fas fa-plus"></i> Incluir Cliente</a>
</li>
@endsection
...
<div class="container-fluid">
	<div class="panel shadow">
		...
		<div class="inside">
        {!! Form::open(['url' => '/admin/client/add', 'files' => 'true']) !!}
                    <div class="row">

                        <div class="col-md-2">
                            <label for="cnpj">Valor da Locação</label>
