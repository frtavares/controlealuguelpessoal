            ...
            <div class="container-fluid">
                ...
                <div class="row mtop16">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('valor', Config::get('madecms.valor_locacao'), ['class' => 'form-control', 'id' => 'valor1', 'step' => 'any', 'readonly' => 'readonly']) !!}
                ...
                <div class="row mtop16">
                    <div class="col-md-12">
                            ...
                            <div class="input-group">
                                {!! Form::textarea('observacoes', '**********************************', ['class' => 'form-control','rows'=>'3', 'maxlength' => '255', 'style' => 'text-transform: uppercase;']) !!}
                            </div>
                        </div>
                </div>
