...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="#"><i class="fas fa-edit"></i> Faturamento Locação - Manutenção</a>
    </li>
@endsection
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            @if(kvfj(Auth::user()->permissions, 'rent_edit'))
                {!! Form::open(['url' => '/admin/rent/'.$r->id.'/edit', 'onkeydown' => 'EnterKeyFilter();']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('client', $clis, $r->client_id, [
                ...
                <div class="row mtop16">
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            {!! Form::select('mes', $mesess, $r->mes_id, ['class' => 'form-control'] ) !!}

                        </div>
                    </div>

                    {!! Form::hidden('ano', $r->ano_id, ['class' => 'form-control'] ) !!}
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            <input type="date" class="form-control" name="vencimento" id="vencimento" value="<?php echo date('Y-m-d',strtotime($r["vencimento"]));?>" /> 
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('valor', Config::get('madecms.valor_locacao'), ['class' => 'form-control' , 'id' => 'valor1','step'=>'any',
                                         'readonly'=> 'readonly'] ) !!}
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            {!! Form::number('condominio',$r->condominio, [
                                'class' => 'form-control',
                                'id'=>'valor3',
                                'step'=>'any'
                                ] ) !!}
                ...
                <div class="row mtop16">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            {!! Form::number('taxaextra',$r->taxaextra, [
                                'class' => 'form-control',
                                'id'=>'valor4',
                                'step'=>'any'
                                ] ) !!}
                    ...
                    {!! Form::hidden('referenciataxa', $r->referenciataxa, ['class' => 'form-control','maxlength' => '50', 'style'=>'text-transform: uppercase;'] ) !!}

                   
                    <div class="col-md-2">
                        <label for="taxaincendio">Taxa Incêndio:</label>
                        <div class="input-group">
                            {!! Form::number('taxaincendio', $r->taxaincendio , [
                                'class' => 'form-control',
                                'id'=>'valor5',
                                'step'=>'any'
                                ] ) !!}
                    ...
                    {!! Form::hidden('referenciataxaincendio', $r->referenciataxaincendio , ['class' => 'form-control','maxlength' => '50', 'style'=>'text-transform: uppercase;'] ) !!}

                    <div class="col-md-2">
                        <label for="iptu">IPTU:</label>
                        <div class="input-group">
                            {!! Form::number('iptu', $r->iptu , [
                                'class' => 'form-control',
                                'id'=>'valor6',
                                'step'=>'any'
                                ] ) !!}
                    ...
                    {!! Form::hidden('referenciaiptu', $r->referenciaiptu , ['class' => 'form-control','maxlength' => '50', 'style'=>'text-transform: uppercase;'] ) !!}
                  

                    <div class="col-md-2">
                        <label for="seguro">Seguro:</label>
                        <div class="input-group">
                            {!! Form::number('seguro', $r->seguro , [
                                'class' => 'form-control',
                                'id'=>'valor7',
                                'step'=>'any'
                                ] ) !!}
                    ...
                    <div class="row mtop16">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                {!! Form::number('desconto', $r->desconto , [
                                    'class' => 'form-control',
                                    'id'=>'valor2',
                                    'step'=>'any'
                                    ] ) !!}
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                {!! Form::text('referenciadesconto', $r->referenciadesconto , ['class' => 'form-control','maxlength' => '20', 'style'=>'text-transform: uppercase;'] ) !!}
                            </div>
                        </div>         
                    </div>            
                ...
                <div class="row mtop16">
                    ...
                    <div class="col-md-2 ">
                        ...
                        <div class="input-group">
                            {!! Form::number('subtotal', $r->subtotal , [
                                'class' => 'form-control',
                                'id'=>'result',
                                'step'=>'any',
                                'readonly'=> 'readonly',
                ...
                <div class="row mtop16">
                    <div class="col-md-12">
                            ...
                            <div class="input-group">
                                {!! Form::textarea('observacoes',  $r->observacoes , ['class' => 'form-control','rows'=>'3', 'maxlength' => '255', 'style' => 'text-transform: uppercase;']) !!}
                            </div>
                        </div>
                </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            jQuery('input').on('keyup', function() {
                ...
                var valor7 = (jQuery('#valor7').val() == '' ? 0 : jQuery('#valor7').val());


                var result = (parseFloat(valor1) + parseFloat(valor3) + parseFloat(valor4) + parseFloat(
                    valor5) + parseFloat(valor6) + parseFloat(valor7));
