						...
						div += "<div class=\"overlay\">";
							div += "<div class=\"btns\">";
								...
								if (auth == "1"){
									...
									div += "<a href=\"#\" id=\"favorite_1_"+product.id+"\" onclick=\"Swal.fire({title: 'Oops...', text: 'Para incluir um favorito é nessessário logar na sua conta!', icon: 'warning'}); return false;\"><i class=\"fas fa-heart\"></i></a>";
								}
							div += "</div>";
						div += "</div>"
